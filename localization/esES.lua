...
MPOWA_CONFIGFRAME_ANIMATION = "Anims"
MPOWA_CONFIGFRAME_FUNCTIONS = "Methods"
MPOWA_CONFIGFRAME_MESSAGES = "Messages"
...
MPOWA_AURA_GONE_SELF = "(.+) acaba de disiparse%."
MPOWA_AURA_GONE_OTHER = "(.+) desaparece de (.+)%."
